...
def extract_features(imgs, cspace='RGB', spatial_size=(32, 32),
    ...
    for img in imgs:
        ...
        # HOG Feature
        hog_feature = get_hog_features(feature_image[:, :, 1], vis=False)

        # Append the new feature vector to the features list
        features.append(np.concatenate((spatial_features, hist_features, hog_feature)))
...
if __name__ == "__main__":
    images = get_file_names('./cutouts', pattern='*jpg')
    cars = []
    not_cars = []
    for img in images:
